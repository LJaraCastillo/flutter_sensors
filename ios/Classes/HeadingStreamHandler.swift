...
public class HeadingStreamHandler : NSObject, FlutterStreamHandler, CLLocationManagerDelegate {
    ...
    public func locationManager(_ manager: CLLocationManager, didUpdateHeading newHeading: CLHeading) {
        ...
        SwiftFlutterSensorsPlugin.notify(sensorId: HeadingStreamHandler.SENSOR_ID, sensorData: data, timestamp: newHeading.timestamp.timeIntervalSince1970 * 1000, eventSink: self.eventSink!)
    }
